...
int main()
{
    ...
    Shader lightshader(SHADER_DIR"/light.vs",SHADER_DIR"/light.fs");
    Shader cubeshader(SHADER_DIR"/cube.vs",SHADER_DIR"/cube.fs");
    ...
    // texture directory: data/texture/
    unsigned int diffuseMap=loadTexture(TEXTURE_DIR"/diffuse.bmp");
    unsigned int specularMap=loadTexture(TEXTURE_DIR"/diffuse.bmp");
    unsigned int normalMap=loadTexture(TEXTURE_DIR"/normal.bmp");
